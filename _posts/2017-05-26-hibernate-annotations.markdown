...
Spring is filled with annotations. It can make your life so much easier and at the same time, a living nightmare. If you forget to put the right annotation in the right spot, Spring will just break and fill your logs with unhelpful error messages. It can be tricky, but when used correctly it can save you from writing a whole lot of code and, even better, having to think out complicated object relationships and try to weave it all together.
